...
// @ts-ignore
const DataCentersOfRegion: (region_key: keyof DataCentersList) => ValueOf<DataCentersList> = (
  region_key
) => {
...
// @ts-ignore
const WorldsOfDataCenter: (data_center_key: keyof WorldsList) => ValueOf<WorldsList> = (
  data_center_key
) => {
