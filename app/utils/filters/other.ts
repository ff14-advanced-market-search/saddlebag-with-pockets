...
export const other: FilterFormat[] = [{
    ...
    name: `Catalysts`, icon: Catalysts
},{
    name: `Miscellany`, icon: Miscellany
},{
    name: `Exterior Fixtures`, icon: ExteriorFixtures
},{
    name: `Interior Fixtures`, icon: InteriorFixtures
},{
    name: `Outdoor Furnishings`, icon: OutdoorFurnishings
},{
    name: `Chairs and Beds`, icon: ChairsAndBeds
},{
    name: `Tables`, icon: Tables
},{
    name: `Tabletop`, icon: Tabletop
},{
    name: `Wall-mounted`, icon: WallMounted
},{
    name: `Rugs`, icon: Rugs
},{
    name: `Seasonal Miscellany`, icon: SeasonalMiscellany
},{
    name: `Minions`, icon: Minions
},{
    name: `Airship/Submersible Components`, icon: AirshipSubmersibleComponents
},{
    name: `Orchestration Components`, icon: OrchestrationComponents
},{
    name: `Gardening Items`, icon: GardeningItems
},{
    name: `Paintings`, icon: Paintings
},{
