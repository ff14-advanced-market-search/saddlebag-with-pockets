...
export const VENDOR_FURNITURE_PATH = `/queries/full-scan?hours=168&salesAmount=2&ROI=50&minimumStackSize=1&minimumProfitAmount=5000&pricePerUnit=3000&filters=-4&hQChecked=false&includeVendorChecked=true&outOfStockChecked=true&regionWideChecked=false`
...
export const OLIVIA_7_PATH = `/queries/full-scan?hours=168&salesAmount=2&ROI=25&minimumStackSize=1&minimumProfitAmount=75000&pricePerUnit=30000&filters=1,2,-5&hQChecked=false&includeVendorChecked=true&outOfStockChecked=true&regionWideChecked=true`
...
export const OLIVIA_9_PATH = `/queries/full-scan?hours=336&salesAmount=1&ROI=25&minimumStackSize=1&minimumProfitAmount=300000&pricePerUnit=300000&filters=1,2,-5&hQChecked=false&includeVendorChecked=true&outOfStockChecked=true&regionWideChecked=true`
...
const replacedPages: Array<{ oldPath: string; newPath: string }> = [
  ...
  { oldPath: '/queries/vendor-furniture-scan', newPath: VENDOR_FURNITURE_PATH },
