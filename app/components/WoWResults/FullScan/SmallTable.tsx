...
/**
 * Renders a responsive desktop table with sorting, filtering, pagination, and CSV export capabilities.
 *
 * This component displays a table with advanced features including fuzzy filtering, dynamic sorting, and
 * pagination controls. It generates column configurations based on the provided definitions and conditionally
 * renders a title, description, and summary information. Additional functionalities include cell highlighting
 * and CSV export.
 *
 * @param data - The dataset to render in the table.
 * @param sortingOrder - An array defining the initial sorting configuration for table columns.
 * @param columnList - The list of column definitions used to generate the table's headers and cells.
 ...
 * @param csvOptions - Optional CSV export configuration.
 * @param fitScreen - Optional flag that, if true, sets the table height to fit the screen.
 * @param highlights - Optional mapping of column IDs to CSS highlight styles for cell emphasis.
 * @param summaryData - Optional summary information displayed at the bottom of the table.
 *
 * @returns A JSX element representing the rendered desktop table.
 */
