const dawntrail70Misc = {
  name: 'Dawntrail 7.0 Furniture, Collectables, Cosmetics, and Miscellaneous items',
  description:
    'Monitor price trends for Dawntrail 7.0 furniture, collectables, cosmetics, and miscellaneous items.',
  config: {
    region: 'NA',
    start_year: 2024,
    start_month: 6,
...
export default dawntrail70Misc
