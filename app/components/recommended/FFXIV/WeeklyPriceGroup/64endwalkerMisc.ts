const endwalker64Misc = {
  name: 'Endwalker 6.4 Furniture, Collectables, Cosmetics, and Miscellaneous items',
  description:
    'Monitor price trends for Endwalker 6.4 furniture, collectables, cosmetics, and miscellaneous items.',
  config: {
    region: 'NA',
    start_year: 2023,
    start_month: 4,
...
export default endwalker64Misc
