const dawntrail75Commodities = {
  name: 'Dawntrail 7.5 Commodities',
  description:
    'Monitor price trends for Dawntrail 7.5 commodities across all categories.',
  config: {
    region: 'NA',
    start_year: 2026,
    start_month: 4,
...
export default dawntrail75Commodities
