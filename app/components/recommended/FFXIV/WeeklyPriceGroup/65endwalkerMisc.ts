const endwalker65Misc = {
  name: 'Endwalker 6.5 Furniture, Collectables, Cosmetics, and Miscellaneous items',
  description:
    'Monitor price trends for Endwalker 6.5 furniture, collectables, cosmetics, and miscellaneous items.',
  config: {
    region: 'NA',
    start_year: 2023,
    start_month: 9,
...
export default endwalker65Misc
