const endwalker65Commodities = {
  name: 'Endwalker 6.5 Commodities',
  description:
    'Monitor price trends for Endwalker 6.5 commodities across all categories.',
  config: {
    region: 'NA',
    start_year: 2023,
    start_month: 9,
...
export default endwalker65Commodities
