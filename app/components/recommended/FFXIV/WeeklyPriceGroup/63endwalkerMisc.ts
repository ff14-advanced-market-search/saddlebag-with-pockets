const endwalker63Misc = {
  name: 'Endwalker 6.3 Furniture, Collectables, Cosmetics, and Miscellaneous items',
  description:
    'Monitor price trends for Endwalker 6.3 furniture, collectables, cosmetics, and miscellaneous items.',
  config: {
    region: 'NA',
    start_year: 2023,
    start_month: 1,
...
export default endwalker63Misc
