const dawntrail71Misc = {
  name: 'Dawntrail 7.1 Furniture, Collectables, Cosmetics, and Miscellaneous items',
  description:
    'Monitor price trends for Dawntrail 7.1 furniture, collectables, cosmetics, and miscellaneous items.',
  config: {
    region: 'NA',
    start_year: 2024,
    start_month: 10,
...
export default dawntrail71Misc
