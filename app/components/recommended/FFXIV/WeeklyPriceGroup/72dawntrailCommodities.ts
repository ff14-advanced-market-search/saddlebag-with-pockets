const dawntrail72Commodities = {
  name: 'Dawntrail 7.2 Commodities',
  description:
    'Monitor price trends for Dawntrail 7.2 commodities across all categories.',
  config: {
    region: 'NA',
    start_year: 2025,
    start_month: 2,
...
export default dawntrail72Commodities
