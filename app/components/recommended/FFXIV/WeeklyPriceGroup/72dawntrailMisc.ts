const dawntrail72Misc = {
  name: 'Dawntrail 7.2 Furniture, Collectables, Cosmetics, and Miscellaneous items',
  description:
    'Monitor price trends for Dawntrail 7.2 furniture, collectables, cosmetics, and miscellaneous items.',
  config: {
    region: 'NA',
    start_year: 2025,
    start_month: 2,
...
export default dawntrail72Misc
