const endwalker64Commodities = {
  name: 'Endwalker 6.4 Commodities',
  description:
    'Monitor price trends for Endwalker 6.4 commodities across all categories.',
  config: {
    region: 'NA',
    start_year: 2023,
    start_month: 4,
...
export default endwalker64Commodities
