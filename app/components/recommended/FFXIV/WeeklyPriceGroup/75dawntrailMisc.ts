const dawntrail75Misc = {
  name: 'Dawntrail 7.5 Furniture, Collectables, Cosmetics, and Miscellaneous items',
  description:
    'Monitor price trends for Dawntrail 7.5 furnishings, cosmetics, and miscellaneous categories.',
  config: {
    region: 'NA',
    start_year: 2026,
    start_month: 4,
...
export default dawntrail75Misc
