const dawntrail70Commodities = {
  name: 'Dawntrail 7.0 Commodities',
  description:
    'Monitor price trends for Dawntrail 7.0 commodities across all categories.',
  config: {
    region: 'NA',
    start_year: 2024,
    start_month: 7,
...
export default dawntrail70Commodities
