      ...
      <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
        ...
        <div className="flex-1 flex flex-col min-h-0 bg-gray-800">
          <div className="flex items-center h-24 flex-shrink-0 px-4 bg-gray-900">
            <Link to={`/`}>
              <img className="h-24 w-auto" src="/images/tiny-chocobo.png" alt={data.site_name} />
            </Link>
          </div>
              ...
              <Menu as="div" className="ml-3 relative">
                <div>
                  <Menu.Button className="max-w-xs bg-white flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    ...
                    <img className="h-8 w-8 rounded-full" src="/images/tiny-chocobo.png" alt="" />
                  </Menu.Button>
                </div>
                <Transition
                  as={Fragment}
                ...
                >
                  <Menu.Items className="origin-top-right absolute right-0 mt-2 w-64 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <p className={`text-gray-700 text-sm py-2 px-4`}>
                      <strong>Welcome to Saddlebag!</strong> We're super freaking hyped to see where
                      this journey together goes. Hoping you make it big! Join our Discord for spicy
                      news!
                    </p>
