...
/**
 * Renders a customizable table with sortable, filterable, and reorderable columns.
 *
 * This React component utilizes TanStack React Table to display data with features such as custom fuzzy filtering,
 * clickable header sorting controls, and optional column ordering. It formats numeric cell values using locale-specific
 * formatting and scrolls the viewport to the top on initial render.
 *
 * @param data - The array of objects to be rendered as table rows.
 * @param sortingOrder - The initial sorting configuration, specifying column IDs and sort directions.
 * @param columnList - An array of column definitions including header labels and optional custom cell renderers.
 * @param order - Optional array representing the initial order of table columns.
 * @param globalFilter - An optional string used to apply a global filter across all rows.
 * @param setGlobalFilter - An optional state setter function to update the global filter value.
 */
