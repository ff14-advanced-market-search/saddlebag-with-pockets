...
export const meta: MetaFunction = () => {
  return [
    ...
    { name: 'description', content: 'Find the best realm to sell any item on! Wow realm population data.' },
    { tagName: 'link', rel: 'canonical', href: 'https://saddlebagexchange.com/wow/export-search' }
  ]
}
