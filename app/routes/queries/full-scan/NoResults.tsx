  ...
  return (
    <div className="text-center py-6">
      ...
      <p className="mt-1 text-sm text-gray-500">
        A quick suggestion would be expanding the <span className={`font-bold`}>Scan Hours</span> to
        a higher number, or lowering the <span className={`font-bold`}>Sale Amount</span>.
      </p>
      <div className="mt-6">
        <Link
          to={href}
