            ...
            <div className="grid grid-cols-6 gap-6">
              <div className="col-span-6 sm:col-span-3 xl:col-span-2">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  ...
                  past 24 hours. For more items to sell choose a higher number.
                </p>
              </div>
              <div className="col-span-6 sm:col-span-3 xl:col-span-2">
                <label
              ...
              <div className="col-span-6 sm:col-span-3 xl:col-span-2">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Desired R.O.I (return on investment): ex: `50` means that 50%
                  of the revenue you get from a sale should be all profit (after
                  tax). For more profit, choose a higher number from 1 to 100.
                </p>
              </div>
              <div className="col-span-6 sm:col-span-3 xl:col-span-2">
                <label
                ...
                <p className="mt-2 text-sm text-gray-500">
                  ...
                  get in stacks of 10 or greater. For more items to sell choose
                  a lower number.
                </p>
              </div>
              ...
              <div className="col-span-6 sm:col-span-3 xl:col-span-2">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Desired Min Profit Amount. ex: `10000` is only show deals that
                  yields 10000 gil profit or greater. For more items to sell
              ...
              <div className="col-span-6 sm:col-span-3 xl:col-span-2">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Desired Average Price Per Unit. ex: `10000` is only show deals
                  that sell on average for 10000 gil or greater. For more items
              ...
              <div className="col-span-6 sm:col-span-3 xl:col-span-2">
                ...
                <div className={`mt-1 flex rounded-md shadow-sm`}>
                  <select
                    ...
                    {filters.map((value) => {
                      ...
                      return (
                        <React.Fragment key={`f_${value.id}`}>
                          <option
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Filters let you limit what type of item you're wanting to
                  search for. Keep in mind, that a low Scan Hours or high Sale
                  Amount value will limit your results.
                  <span className={`italic hidden md:block`}>
                    Spicy side note, this is a multi-select filter. Hold CTRL or
                    SHIFT + click to select multiple if on a keyboard.
                  </span>
                </p>
              </div>
                ...
                <fieldset className="space-y-5">
                  ...
                  <div className="relative flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                      ...
                      <p className="mt-2 text-sm text-gray-500">
                        Compare market prices vs vendor prices on NQ items that
                ...
                <fieldset className="space-y-5">
                  ...
                  <div className="relative flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                      ...
                      <p className="mt-2 text-sm text-gray-500">
                        Include out of stock items from the list (they will show
                        up as having 100% profit margins and 1 bil gil profit).
                      </p>
                    </div>
                  </div>
                </fieldset>
