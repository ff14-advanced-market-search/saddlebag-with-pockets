              ...
              <div className="flex w-0 flex-1 items-center">
                ...
                <p className="ml-3 truncate font-medium text-white">
                  ...
                  <span className="hidden md:inline">
                    Heads up, this table is pretty wide. You'll probably need to scroll horizontally
                    (left & right).
                  </span>
                </p>
              </div>
                    ...
                    {headerGroup.headers.map((header) => (
                      ...
                      >
                        <div className={`group inline-flex`}>
                          ...
                          <div
                            className={classNames(
                              header.column.getIsSorted() ? "bg-gray-200 rounded bg-gray-200" : "",
                              ` ml-1 flex-none p-1`
                            )}
                          >
                            {{
                              asc: (
                                <span className={`text-gray-900 group-hover:bg-gray-300`}>
