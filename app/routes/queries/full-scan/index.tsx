                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                                    ...
                                    <div className="grid grid-cols-6 gap-6">
                                        <div className="col-span-6 sm:col-span-2">
                                            ...
                                            <p className="mt-2 text-sm text-gray-500">
                                                The time period to search over. ex: <code>24</code> is the past 24
                                                hours.
                                                For more items to sell choose a higher number.
                                            </p>
                                        </div>
                                        <div className="col-span-6 sm:col-span-2">
                                            <label htmlFor="sale-amt"
                                                   className="block text-sm font-medium text-gray-700">
                                                Sale Amount
                                            </label>
                                            <input
                                        ...
                                        <div className="col-span-6 sm:col-span-2">
                                            ...
                                            <p className="mt-2 text-sm text-gray-500">
                                                Desired R.O.I (return on investment): ex: `50` means that 50% of the
                                                revenue
                                        ...
                                        <div className="col-span-6 sm:col-span-2">
                                            ...
                                            <p className="mt-2 text-sm text-gray-500">
                                                Desired Min Stack Size. ex: `10` is only show deals you can get in
                                                stacks of
                                        ...
                                        <div className="col-span-6 sm:col-span-2">
                                            ...
                                            <p className="mt-2 text-sm text-gray-500">
                                                Desired Min Profit Amount. ex: `10000` is only show deals that yields
                                                10000
                                        ...
                                        <div className="col-span-6 sm:col-span-2">
                                            ...
                                            <p className="mt-2 text-sm text-gray-500">
                                                Desired Average Price Per Unit. ex: `10000` is only show deals that sell
                                                on
                                            ...
                                            <fieldset className="space-y-5">
                                                ...
                                                <div className="relative flex items-start">
                                                    ...
                                                    <div className="ml-3 text-sm">
                                                        ...
                                                        <p className="mt-2 text-sm text-gray-500">
                                                            Compare market prices vs vendor prices on NQ items that can
                                                            be
                                            ...
                                            <fieldset className="space-y-5">
                                                ...
                                                <div className="relative flex items-start">
                                                    ...
                                                    <div className="ml-3 text-sm">
                                                        ...
                                                        <p className="mt-2 text-sm text-gray-500">
                                                            Include out of stock items from the list (they will show up
                                                            as
                        ...
                        <div className="flex justify-end">
                            <button
                                ...
                                // @ts-ignore
                                onClick={onSubmit}
                                className={classNames(transition.state === 'submitting'
                                                      ? 'bg-gray-500'
                                                      : 'bg-blue-600', "cursor-pointer ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500")}
                            >
