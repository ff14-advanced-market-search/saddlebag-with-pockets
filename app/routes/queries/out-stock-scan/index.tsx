        ...
        <Form method="post">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            <h1 className="text-2xl font-semibold text-green-900 py-6">
              Out Of Stock - Buy at least 5 items not listed on your server which cost under 5k. Sell them on your market board for 70k. Not all will guarenteed sell, but you only need 1 sale to give a massive profit margin.
            </h1>
