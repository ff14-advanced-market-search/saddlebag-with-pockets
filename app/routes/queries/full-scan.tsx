                                    ...
                                    <div className="grid grid-cols-6 gap-6">
                                        <div className="col-span-6 sm:col-span-2">
                                            ...
                                            <p className="mt-2 text-sm text-gray-500">
                                                The time period to search over. ex: <code>24</code>{" "}
                                                is the past 24 hours. For more items to sell choose
                                                a higher number.
                                            </p>
                                        </div>
                                        <div className="col-span-6 sm:col-span-2">
                                            ...
                                            />
                                            <p className="mt-2 text-sm text-gray-500">
                                                Number of sales in that time. ex: `5` is 5 sales in
                                        ...
                                        <div className="col-span-6 sm:col-span-2">
                                            ...
                                            <p className="mt-2 text-sm text-gray-500">
                                                ...
                                                that 50% of the revenue you get from a sale should
                                                be all profit (after tax). For more profit, choose a
                                                higher number from 1 to 100.
                                            </p>
                                        </div>
                                    </div>
                                </div>
