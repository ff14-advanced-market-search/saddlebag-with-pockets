...
// Chart loading skeleton fallback
const ChartLoadingSkeleton = () => (
  <div className="min-h-[300px] animate-pulse bg-gray-100 dark:bg-gray-800 rounded" />
)
                    ...
                    <GenericLineChart
                      ...
                      dataIterator={(val, ind) => [
                        makeTimeString({
                          date: now,
                          hoursToDeduct:
                            listing.priceTimeData.length - ind
                        }),
                        val
                      ]}
                    ...
                    <GenericLineChart
                      ...
                      dataIterator={(val, ind) => [
                        makeTimeString({
                          date: now,
                          hoursToDeduct:
                            listing.quantityTimeData.length - ind
                        }),
                        val
                      ]}
                      xCategories={xCategories}
