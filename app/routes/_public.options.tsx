...
/**
 * Renders the options configuration page for site settings.
 *
 * This component initializes configuration state based on session data and provides UI elements for updating
 * FFXIV world selections, WoW home realm, and theme settings via dark mode. It dispatches actions to update
 * the application state upon form submission and prevents the form from submitting again while a submission
 * is in progress.
 *
 * @returns A JSX element representing the options menu.
 */
