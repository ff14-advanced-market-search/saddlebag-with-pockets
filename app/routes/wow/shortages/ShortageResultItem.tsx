...
export const WoWShortageItem = (item: WoWShortage) => (
  <div
        ...
        <div className="my-2 border-2 border-black rounded p-2">
          ...
          Math.floor(
            ...
            <TextRow
              leftText="List for:"
              rightText={numberToLocaleStringWithDecimal(
                item.max_sane_flip_level.listing_price_level.from_price_level -
                  1
              )}
            />
          ) : (
            <TextRow
              ...
              rightText={`${numberToLocaleStringWithDecimal(
                ...
                Math.floor(
                  item.max_sane_flip_level.listing_price_level.to_price_level -
                    1
                )
              )}`}
            />
