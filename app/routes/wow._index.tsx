...
/**
 * Renders the main page for the World of Warcraft auction house tools.
 *
 * This default component builds the primary interface by displaying a hero section with
 * a background image, title, description, and call-to-action buttons for downloading the
 * tool or learning more. It also includes a promotional Banner component and a dynamic grid
 * of tool cards built from a list of recommended queries. A hidden SEO paragraph is added to
 * enhance search engine visibility.
 *
 * @returns A React element representing the full page layout.
 */
