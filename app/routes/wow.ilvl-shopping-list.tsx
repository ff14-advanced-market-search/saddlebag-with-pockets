...
export const loader: LoaderFunction = async ({ request }) => {
  ...
  const desiredMinIlvl = params.get('desiredMinIlvl') || '141'
  const desiredStats = [
    ...new Set(
      params
        .getAll('desiredStats')
...
const IlvlShoppingListComponent = () => {
  ...
  const [desiredMinIlvl, setDesiredMinIlvl] = useState<string>('141')
  ...
  useEffect(() => {
    ...
    const desiredMinIlvlFromUrl = searchParams.get('desiredMinIlvl') || '141'
