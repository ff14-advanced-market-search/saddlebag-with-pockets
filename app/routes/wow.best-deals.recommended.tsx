...
export const meta: MetaFunction = () => {
  return [
    ...
    { name: 'description', content: 'Saddlebag Exchange: WoW Amazing Auction House Deals' },
    { tagName: 'link', rel: 'canonical', href: 'https://saddlebagexchange.com/wow/best-deals/recommended' }
  ]
}
