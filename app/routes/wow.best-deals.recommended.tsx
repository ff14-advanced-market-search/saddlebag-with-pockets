...
const searchParams = {
  ...
  recipesMidnight:
    '/wow/best-deals?type=df&itemClass=9&itemSubClass=-1&discount=50&minPrice=10000&salesPerDay=0.1&expansionNumber=12',
  legacyRecipes:
...
const recommendedQueries = [
  ...
  },
  {
    ...
    description:
      'Find Midnight recipes at a discount for crafting advancements.',
    Icon: DocumentSearchIcon,
    href: searchParams.recipesMidnight
  },
  {
    name: 'Legacy Recipes',
    description:
    ...
    <>
      <main className="flex-1">
        ...
        <p style={{ fontSize: '1px' }}>
          ...
          and other essentials. Default Midnight Deals: Discover discounted
