...
/**
 * Renders the main page for the FFXIV Craftsim profit simulation tool.
 *
 * This component displays a banner, a heading, and a grid of recommended queries.
 * Each query is represented as a clickable tile that directs users to specific crafting scenarios.
 */
