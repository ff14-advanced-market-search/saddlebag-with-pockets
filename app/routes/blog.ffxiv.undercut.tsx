  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <main className="prose prose-lg prose-slate mx-auto">
        <h1 className="text-4xl font-bold mb-8" id="ffxiv-marketboard-undercutting-guide">
        ...
        <div className="bg-slate-100 p-6 rounded-lg mb-8">
          ...
          <nav className="flex flex-col space-y-2">
            <a href="#understanding-undercutting" className="text-blue-600 hover:text-blue-800">Understanding Undercutting</a>
            <a href="#saddlebag-exchange-solution" className="text-blue-600 hover:text-blue-800">Saddlebag Exchange Solution</a>
            <a href="#getting-started" className="text-blue-600 hover:text-blue-800">Getting Started Guide</a>
            <a href="#features-benefits" className="text-blue-600 hover:text-blue-800">Features and Benefits</a>
          </nav>
        </div>

        {/* Main Content - Split into sections */}
        <section id="understanding-undercutting">
          <h2 className="text-2xl font-bold mb-4">Understanding Undercutting</h2>
          <p>
            In the bustling virtual economy of Final Fantasy XIV (FFXIV), mastering the Marketboard 
            is crucial for any merchant aspiring to profit. This guide dives deep into the strategy 
            of undercutting, a common yet powerful technique, and introduces an invaluable tool: 
        ...
        <section id="saddlebag-exchange-solution">
          <h2 className="text-2xl font-bold mb-4">Saddlebag Exchange: A Game-Changing Solution</h2>
          <p>
            This is where Saddlebag Exchange comes into play. By utilizing our Discord bot alerts, 
            merchants can receive notifications whenever they are undercut. This service taps into 
            the Universalis data, ensuring that the information is both current and accurate.
          </p>
          {/* ... rest of the solution section ... */}
        </section>

        <section id="getting-started">
          <h2 className="text-2xl font-bold mb-4">Getting Started with Saddlebag Exchange</h2>
          <div className="bg-blue-50 p-6 rounded-lg mb-8">
            <h3 className="text-xl font-semibold mb-4">Quick Start Steps:</h3>
            <ol className="list-decimal list-inside space-y-3">
              <li>Join our <a href="https://discord.gg/saddlebagexchange" className="text-blue-600 hover:text-blue-800">Discord server</a></li>
              <li>Visit the <Link to="/undercut" className="text-blue-600 hover:text-blue-800">Undercut Alert setup page</Link></li>
        ...
        <div className="bg-blue-100 p-6 rounded-lg mt-8">
          <h2 className="text-2xl font-bold mb-4">Ready to Dominate the Marketboard?</h2>
          <p className="mb-4">
            Join thousands of successful FFXIV traders using Saddlebag Exchange to maximize their profits.
          </p>
