...
export const loader: LoaderFunction = () => {
  const adsText = `OWNERDOMAIN=saddlebagexchange.com
MANAGERDOMAIN=nextmillennium.io
...
nextmillennium.io, 16950, DIRECT, 65bd090fa4a1e3d6

admagnetix.io, 201994, DIRECT
...
gumgum.com,15365, RESELLER, ffdef49475d318a9
