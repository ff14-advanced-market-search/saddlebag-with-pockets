...
/**
 * Renders the Saddlebag Exchange homepage.
 *
 * This component assembles the layout for the main page, including a hero section with a background image and navigation buttons,
 * a dynamic features section built from a list of recommended queries, an about section tailored for Final Fantasy XIV and World of Warcraft users,
 * a call-to-action prompting users to join via Discord, and a footer with copyright information.
 * It also includes hidden SEO content to enhance search engine visibility.
 */
