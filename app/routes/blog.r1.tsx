...
export const meta: MetaFunction = () => {
  return [
    ...
    { tagName: 'link', rel: 'canonical', href: 'https://saddlebagexchange.com/blog/r1' }
  ]
}
    ...
    <div className={`m-12`}>
      <main className="flex-1">
        ...
        <p className={`text-prose`}>
          ...
          {/*<p><img src="https://user-images.githubusercontent.com/124644331/219824318-c395ce05-9a68-4fe4-9840-874e94097c6d.png" alt="image"></p>*/}
          <p>
            However, it’s also currently available for only 52,500 gil on
            another server in my Data Center:
          </p>
          {/*<p><img src="https://user-images.githubusercontent.com/124644331/219824331-b31cacdf-9cb9-4919-878a-4166de87d859.png" alt="image"></p>*/}
          <p>
          ...
          {/*<p><img src="https://user-images.githubusercontent.com/124644331/219824410-e6b0a020-cd19-4177-9d32-0806ceddeb50.png" alt="image"></p>*/}
          <p>
          ...
          {/*<p><img src="https://user-images.githubusercontent.com/124644331/219824435-65a8fd9c-c038-4d9b-8b66-aac299d0f4b8.png" alt="image"></p>*/}
          <p>
